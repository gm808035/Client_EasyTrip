<template>
  <div class="">
    ...
    <div  class="container">
          <div >
            <div  class="car">
              <label style="margin-left: -150px; margin-top: 20px">Страна</label>
              <label style="margin: -22px 0 0 150px; font-size: 18px; color: #00004d">Germany</label>
              <label style="margin-left: -150px; margin-top: 20px">Модель</label>
              <label style="margin: -28px 0 0 150px; font-size: 18px; color: #00004d">bmw</label>
              <label style="margin-left: -150px; margin-top: 20px">Номерной знак</label>
              <label style="margin: -28px 0 0 150px; font-size: 18px; color: #00004d">9488</label>

            </div>

          </div>
      <i style="margin-left: 500px; margin-top: -400px; " class="fa fa-pencil-square-o" aria-hidden="true"> Изменить</i>
      <a style="margin-left: 500px; color: black" class="kop" href="/car" ><i class="fa fa-trash-o mr-1" aria-hidden="true"></i> Удалить</a>
